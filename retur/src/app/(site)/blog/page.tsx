...
export default async function BlogPage() {
  ...
  return (
    <main className="flex min-h-screen flex-col font-manrope bg-[#F8F6F3] text-[#221a15]">
      ...
      <section className="relative h-[350px] flex items-center justify-center overflow-hidden pt-20 bg-slate-900">
        <div className="absolute inset-0 z-0 opacity-60">
          <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-black/30"></div>
        </div>
        
        <div className="relative z-10 text-center text-white px-8 max-w-4xl mx-auto w-full">
          <nav className="mb-4 flex justify-center items-center gap-2 font-inter text-xs uppercase tracking-widest text-white/80">
